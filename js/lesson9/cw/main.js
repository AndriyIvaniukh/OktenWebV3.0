...
for (const arrEl of coursesArray) {
    const div = document.createElement('div');

    const divTitle = document.createElement('div');
    divTitle.innerText = arrEl.title;
    const divMonth = document.createElement('div');
    divMonth.innerText = arrEl.monthDuration;
    const divHour = document.createElement('div');
    divHour.innerText = arrEl.hourDuration;
    const divModules = document.createElement('div');
    const ul = document.createElement('ul');
    for (const module of arrEl.modules) {
    ...
    div.append(divTitle, divMonth, divHour, divModules);
    document.body.appendChild(div);
}